...
4. **AI Integration**
   - Which AI providers should be supported (Gemini, OpenRouter, Replicate)?
   - How should API keys be stored and managed?
   - Are there rate limiting or cost control requirements?
