      ...
      <div className="flex items-end gap-3 p-3 rounded-2xl bg-zinc-900/50 shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            rows={1}
            className="w-full px-4 py-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-teal-500/50 focus:shadow-[0_0_20px_rgba(20,184,166,0.15)] transition-all resize-none shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]"
