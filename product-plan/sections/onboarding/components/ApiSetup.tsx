          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="https://makersuite.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-xs text-teal-400 hover:text-teal-300 transition-colors">
                  Get key
                </a>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="https://openrouter.ai/keys" target="_blank" rel="noopener noreferrer" className="text-xs text-teal-400 hover:text-teal-300 transition-colors">
                  Get key
                </a>
              </div>
              <div className="relative">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="https://replicate.com/account/api-tokens" target="_blank" rel="noopener noreferrer" className="text-xs text-teal-400 hover:text-teal-300 transition-colors">
                  Get key
                </a>
              </div>
              <div className="relative">
            ...
            <div className="p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
              <p className="text-sm text-zinc-400">
                Your API keys are stored securely and only used to power AI features. You can add or update them later in Settings.
              </p>
            </div>
