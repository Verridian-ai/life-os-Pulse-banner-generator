...
const TIER_FEATURES = {
  free: ['100 credits/month', 'Basic image generation', 'Standard templates', 'Community support'],
  basic: [
    '500 credits/month',
...
export function PricingCards({
  ...
  const renderTierCard = (
    ...
    const isUpgrade =
      tier !== 'free' &&
      (currentTier === 'free' || (currentTier === 'basic' && tier === 'premium'));
    const isDowngrade =
    ...
    return (
      <div
        ...
        className={`relative rounded-2xl border p-6 ${
          highlighted ? 'border-purple-500/50 bg-purple-500/5' : 'border-white/10 bg-zinc-900'
