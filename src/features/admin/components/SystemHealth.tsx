...
import { getSystemHealth, type SystemHealthResponse, type ServiceHealth } from '../services/adminApi';
...
export function SystemHealth({ autoRefresh = true, refreshInterval = 30000 }: SystemHealthProps): React.ReactElement {
    ...
    const overallStatusColor = health?.overall === 'healthy'
        ? 'text-green-400'
            ...
            <div className="p-4">
                ...
                {isLoading && !health ? (
                    <div className="space-y-3">
                        {[1, 2, 3, 4, 5].map((i) => (
                            <div key={i} className="flex items-center justify-between p-3 bg-zinc-800/30 rounded-lg animate-pulse">
                                <div className="flex items-center gap-3">
