...
export type PostTemplate = 'story' | 'educational' | 'listicle' | 'contrarian' | 'video' | 'job_update';

export type EmotionalTone = 'educational' | 'inspirational' | 'bold' | 'minimalist' | 'dramatic' | 'professional';
