  ...
  return (
    <div className='space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500'>
            ...
            return isSelected ? (
              ...
              >
                <div className='flex items-center gap-3 mb-1'>
                  <span className='material-icons text-sm text-blue-500'>{tmpl.icon}</span>
              ...
              >
                <div className='flex items-center gap-3 mb-1'>
                  <span className='material-icons text-sm text-zinc-500'>{tmpl.icon}</span>
                  <span className='text-xs font-bold text-white'>{tmpl.label}</span>
                </div>
                <p className='text-[10px] text-zinc-500 leading-tight'>{tmpl.description}</p>
              </button>
      ...
      <div className='space-y-3'>
        ...
        <div className='flex flex-wrap gap-2' role='radiogroup' aria-label='Content tone'>
