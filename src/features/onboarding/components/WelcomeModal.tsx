          ...
          {!showSteps ? (
            ...
            <>
              ...
              <div className='flex justify-center mb-6'>
                <div className='w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center animate-pulse'>
                  <span className='material-icons text-white text-4xl'>celebration</span>
                </div>
              </div>
              ...
              <div className='text-center mb-8'>
                ...
                <p className='text-zinc-400 text-lg'>You're all set to create amazing banners</p>
              </div>
              ...
              <div className='bg-white/5 border border-white/10 rounded-2xl p-6 mb-8'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='text-right'>
                    ...
                    <p className='text-xl font-bold text-purple-400'>{credits.toLocaleString()}</p>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div className='flex gap-3'>
                ...
                >
                  {currentStep === QUICK_START_STEPS.length - 1 ? 'Go to Studio' : 'Next'}
                </button>
              </div>
