...
import { RefreshCw, ArrowLeft, Linkedin, Youtube, Instagram, Facebook, Twitter, Music2 } from 'lucide-react';
import type { PlatformType } from '../dashboard';
import { formatTooltip } from '../../utils/stringUtils';

// Platform display config
const platformDisplay: Record<PlatformType, { name: string; icon: React.ElementType; color: string }> = {
