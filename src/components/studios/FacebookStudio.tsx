/**
 * FacebookStudio - Platform-specific studio for Facebook content
 *
 * Features:
 * - Filtered format selector (Facebook formats only: story, post, cover, event, group)
 * - NO profile overlay
 * - Share to Facebook button (disabled until API integration)
 * - Facebook brand colors (blue gradient)
 */
...
export function FacebookStudio({
  genPrompt = '',
  setGenPrompt = () => {},
  genSize = '1K',
  setGenSize = () => {},
