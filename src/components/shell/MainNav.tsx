  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, rgba(250, 204, 21, 0.1), transparent 50%, rgba(250, 204, 21, 0.1))',
        }}
      />
        ...
        {items.map((item, _index) => {
          ...
          return (
            ...
            >
              ...
              <span
                style={{
                  color: isActive ? '#facc15' : isHovered ? '#fde047' : '#78716c',
      ...
      <div className='mt-auto p-4'>
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(41, 37, 36, 0.8) 0%, rgba(28, 25, 23, 0.9) 100%)',
        ...
        >
          ...
          {/* Content */}
          <h3 className='font-bold text-white mb-1.5 relative z-10 text-[15px]'>Upgrade to Pro</h3>
          <p className='text-xs leading-relaxed relative z-10 mb-4 text-stone-400'>
          ...
          >
            ...
            <ArrowRight className='w-3.5 h-3.5 transition-all duration-300 opacity-0 -ml-3' />
          </button>
        </div>
      </div>
    </aside>
