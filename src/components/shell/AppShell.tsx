...
export function AppShell({
  ...
  const displayName =
    user?.full_name || user?.username || (user?.email || authUser?.email)?.split('@')[0] || 'User';
          ...
          <form onSubmit={handleSearch} className='flex-1 max-w-lg mx-6 hidden lg:block'>
            ...
            >
              ...
              <input
                ...
                style={{
                  background: searchFocused ? 'rgba(28, 25, 23, 1)' : 'rgba(28, 25, 23, 0.8)',
                  border: searchFocused
                    ? '1px solid rgba(250, 204, 21, 0.4)'
                    : '1px solid rgba(255, 255, 255, 0.08)',
                  borderRadius: '12px',
                  boxShadow: searchFocused ? '0 0 0 3px rgba(250, 204, 21, 0.1)' : 'none',
        ...
        <div className='fixed bottom-24 lg:bottom-8 right-4 lg:right-8 z-50'>
          ...
          <button
            ...
            style={{
              ...
              cursor: voiceConnectionState === 'connecting' ? 'wait' : 'pointer',
          ...
          {/* Status label */}
          {(voiceConnectionState === 'connecting' || voiceConnectionState === 'error') && (
            <div
              ...
              style={{
                background:
                  voiceConnectionState === 'connecting'
                    ? 'rgba(250, 204, 21, 0.2)'
                    : 'rgba(239, 68, 68, 0.2)',
                color: voiceConnectionState === 'connecting' ? '#FACC15' : '#ef4444',
              }}
            >
