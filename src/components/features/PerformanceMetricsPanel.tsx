    ...
    <div className='bg-black/40 p-5 rounded-3xl border border-white/5'>
      ...
      <div className='grid grid-cols-2 gap-3 mb-4'>
        ...
        <div className='bg-gradient-to-br from-purple-900/30 to-purple-800/20 border border-purple-500/30 rounded-xl p-4'>
          ...
          <p className='text-2xl font-black text-purple-400'>{formatTime(stats.avgResponseTime)}</p>
        </div>
        ...
        <div className='bg-zinc-900/50 rounded-xl p-4 mb-4'>
          ...
          <div className='grid grid-cols-2 gap-2'>
            {Object.entries(stats.operationsByType)
              .sort(([, a], [, b]) => b - a)
              .map(([operation, count]) => (
                <div key={operation} className='bg-zinc-800 border border-white/10 rounded-lg p-3'>
              ...
              .map((metric, idx) => (
                ...
                >
                  ...
                  <div className='flex justify-between text-[10px]'>
                    <span className='text-zinc-500'>{formatTime(metric.responseTime)}</span>
