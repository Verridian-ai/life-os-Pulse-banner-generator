...
const CanvasEditor: React.FC = () => {
    const {
        canvasRef, bgImage, elements, showSafeZones, setShowSafeZones,
        profilePic, setProfilePic, setElements, selectedElementId, setSelectedElementId
    } = useCanvas();
            ...
            <div className="w-full max-w-[1400px]">
                ...
                <div className="mb-6 flex flex-wrap justify-between items-center gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-white text-sm font-black uppercase tracking-wider drop-shadow-sm">Canvas View</h2>
                            <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">{BANNER_WIDTH} x {BANNER_HEIGHT} PX</p>
                        </div>
                    </div>
                    ...
                    >
                        <span className="material-icons text-sm">{showSafeZones ? 'visibility' : 'visibility_off'}</span>
