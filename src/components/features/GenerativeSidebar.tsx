    ...
    <div className='space-y-4 md:space-y-6'>
      ...
      <div className='flex bg-zinc-900/80 rounded-2xl p-1 border border-white/10 shadow-inner gap-0.5 sm:gap-1'>
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 sm:gap-1.5 min-h-[44px] px-1.5 sm:px-3 md:px-4 rounded-xl text-[9px] sm:text-[10px] md:text-[11px] font-black uppercase tracking-wide sm:tracking-wider transition-all touch-manipulation active:scale-[0.98] ${activeMode === 'edit'
        ...
        <div className='bg-black/40 p-3 sm:p-5 rounded-2xl sm:rounded-3xl border border-white/5 hover:border-pink-500/30 transition-colors group relative overflow-hidden flex flex-col'>
          ...
          <div className='flex justify-between items-center mb-3 sm:mb-4 relative z-10'>
            <div className='flex items-baseline gap-2'>
              ...
              {genPrompt.length > 0 && (
                <span className={`text-[9px] font-bold uppercase tracking-wider transition-colors duration-300 ${genPrompt.length < 15 ? 'text-yellow-500' :
          ...
          {isMobile ? (
            <div className='mb-3 sm:mb-4 relative z-10'>
              ...
              >
                ...
                <span className={`material-icons text-xs transition-transform ${showAdvanced ? 'rotate-180' : 'rotate-0'}`}>
                  expand_more
                </span>
              </button>
              {showAdvanced && (
        ...
        <div className='bg-black/40 p-3 sm:p-5 rounded-2xl sm:rounded-3xl border border-white/5 hover:border-yellow-500/30 transition-colors relative overflow-hidden group'>
          ...
          <div className='flex items-center justify-between mb-3 sm:mb-4 relative z-10'>
            <div className='flex items-baseline gap-2'>
              ...
              {editPrompt.length > 0 && (
                <span className={`text-[9px] font-bold uppercase tracking-wider transition-colors duration-300 ${editPrompt.length < 15 ? 'text-yellow-500' :
