...
const ImageGallery: React.FC = () => {
    ...
    const getTypeBadgeColor = (type: string) => {
        switch (type) {
            ...
            case 'remove-bg': return 'bg-orange-600/20 text-orange-400 border-orange-500/30';
            case 'restore': return 'bg-pink-600/20 text-pink-400 border-pink-500/30';
            case 'face-enhance': return 'bg-yellow-600/20 text-yellow-400 border-yellow-500/30';
                ...
                {!loading && images.length === 0 && (
                    <div className="flex items-center justify-center py-20">
                        <div className="flex flex-col items-center gap-3 max-w-md text-center">
                            <span className="material-icons text-6xl text-zinc-600">
                                photo_library
                            </span>
                                    ...
                                    <div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex flex-col justify-between p-4 animate-fadeIn">
                                        ...
                                        <div className="flex-1 overflow-y-auto">
                                            <div className="space-y-2">
                                                {/* Type Badge */}
                                                <span className={`inline-block px-2 py-1 rounded text-[9px] font-black uppercase tracking-wider border ${getTypeBadgeColor(image.generation_type)}`}>
