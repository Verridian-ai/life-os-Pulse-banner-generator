  ...
  const getFeaturedModels = () => {
    if (provider === 'gemini') {
      return [
        ...
        { id: MODELS.textThinking, name: 'Gemini 3 Pro Preview', description: 'Advanced reasoning' },
      ...
      return [
        ...
        { id: MODELS.openrouter.minimaxM2, name: 'MiniMax M2 Plus', description: 'Coding & agentic tasks' },
