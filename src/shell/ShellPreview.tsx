        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-400">
              Choose a platform to start creating.
            </p>
          </div>
          <button type="button" className="w-full md:w-auto py-3 px-6 bg-gradient-to-r from-sky-400 to-teal-500 hover:from-sky-300 hover:to-teal-400 rounded-xl font-bold text-white shadow-lg shadow-sky-900/30 flex items-center justify-center gap-2 transform transition hover:scale-[1.02]">
