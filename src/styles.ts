...
export const BTN_PURPLE_INACTIVE =
  'bg-zinc-900 text-purple-500 shadow-[4px_4px_8px_rgba(0,0,0,0.5),-4px_-4px_8px_rgba(255,255,255,0.05)] border border-purple-500/20 hover:text-purple-400 hover:border-purple-500/50 hover:shadow-[0_0_15px_rgba(168,85,247,0.2)]';
...
export const BTN_RED_INACTIVE =
  'bg-zinc-900 text-red-500 shadow-[4px_4px_8px_rgba(0,0,0,0.5),-4px_-4px_8px_rgba(255,255,255,0.05)] border border-red-500/20 hover:text-red-400 hover:border-red-500/50 hover:shadow-[0_0_15px_rgba(220,38,38,0.2)]';
...
export const BTN_GREEN_INACTIVE =
  'bg-zinc-900 text-green-500 shadow-[4px_4px_8px_rgba(0,0,0,0.5),-4px_-4px_8px_rgba(255,255,255,0.05)] border border-green-500/20 hover:text-green-400 hover:border-green-500/50 hover:shadow-[0_0_15px_rgba(34,197,94,0.2)]';
...
export const BTN_NEU_SOLID =
  'bg-zinc-800 text-zinc-400 shadow-[3px_3px_6px_rgba(0,0,0,0.5),-3px_-3px_6px_rgba(255,255,255,0.05)] border border-white/5 hover:text-white hover:scale-[1.02] active:scale-[0.98]';
