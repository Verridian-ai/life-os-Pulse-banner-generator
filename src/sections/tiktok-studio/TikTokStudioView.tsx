    ...
    <div className='min-h-screen bg-zinc-950 p-4 md:p-6 lg:p-8 relative overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='flex items-center justify-between mb-8'>
          ...
          <button
            type='button'
            className='px-6 py-3 bg-gradient-to-r from-cyan-400 via-pink-500 to-red-500 hover:from-cyan-300 hover:via-pink-400 hover:to-red-400 text-white font-semibold rounded-xl transition-all shadow-[0_0_30px_rgba(236,72,153,0.4)]'
          >
            Export
          </button>
        </div>
            ...
            <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6'>
              ...
              <div className='mt-6'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {['Tutorial', 'POV', 'Storytime', 'Transition', 'Duet', 'Green Screen'].map(
                    (format) => (
                      <button
                        key={format}
                        type='button'
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05),inset_0_1px_1px_rgba(255,255,255,0.1),0_0_40px_rgba(236,72,153,0.3)] rounded-2xl p-6'>
              ...
              <div className='flex items-center justify-center mb-6'>
                <div className='relative w-32 h-32'>
                  ...
                  <div className='absolute inset-0 flex flex-col items-center justify-center'>
                    <span className='text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-pink-500 to-red-500'>
                      {viralScore}
                    </span>
              ...
              <div className='flex items-center justify-between p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]'>
                ...
                <span className='text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-500'>
                  {fypPotential}%
                </span>
              </div>
            </div>
