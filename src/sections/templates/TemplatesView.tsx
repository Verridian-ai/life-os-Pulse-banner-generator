...
const industries = ['All', 'Technology', 'Finance', 'Marketing', 'Healthcare', 'Education', 'E-commerce', 'Creative'];

const sampleTemplates: Template[] = [
  { id: '1', title: 'Tech Startup Banner', industry: 'Technology', platform: 'linkedin', thumbnailUrl: '' },
  { id: '2', title: 'Product Launch', industry: 'Marketing', platform: 'instagram', thumbnailUrl: '' },
  { id: '3', title: 'Financial Report', industry: 'Finance', platform: 'linkedin', thumbnailUrl: '' },
  { id: '4', title: 'Course Promotion', industry: 'Education', platform: 'youtube', thumbnailUrl: '' },
  { id: '5', title: 'E-commerce Sale', industry: 'E-commerce', platform: 'facebook', thumbnailUrl: '' },
  { id: '6', title: 'Portfolio Showcase', industry: 'Creative', platform: 'instagram', thumbnailUrl: '' },
              ...
              >
                ...
                <div className="aspect-video bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 relative">
                  ...
                  <div className="absolute inset-0 bg-black/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                    <button type="button" className="px-6 py-2.5 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-medium rounded-xl shadow-[0_0_20px_rgba(20,184,166,0.5)] hover:shadow-[0_0_30px_rgba(20,184,166,0.7)] transition-all duration-300 transform hover:scale-105">
                      Use Template
                    </button>
                  </div>
                ...
                {/* Info */}
                <div className="p-4">
                  <h3 className="text-sm font-medium text-white mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-sky-400 group-hover:to-teal-400 transition-all duration-300">{template.title}</h3>
