  ...
  return (
    <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6'>
      ...
      <div className='flex items-center justify-between mb-4'>
        <h3 className="text-lg font-semibold text-white font-['Space_Grotesk']">Copywriting</h3>
        <button
          onClick={onRewrite}
      ...
      <div className='mb-4'>
        ...
        <div className='flex items-center justify-between mt-2'>
          ...
          <p className={`text-sm font-medium ${getCharCountColor()}`}>{charCount} characters</p>
        </div>
      </div>
