...
const sampleScore = {
  overall: 78,
  factors: [
    { id: 'hook', name: 'Hook Strength', score: 85, maxScore: 100, weight: 0.25, suggestion: 'Strong opening line' },
    { id: 'structure', name: 'Structure', score: 70, maxScore: 100, weight: 0.20, suggestion: 'Add more whitespace' },
    { id: 'engagement', name: 'Engagement Potential', score: 80, maxScore: 100, weight: 0.25, suggestion: 'Good use of questions' },
    { id: 'hashtags', name: 'Hashtags', score: 75, maxScore: 100, weight: 0.15, suggestion: 'Add 1-2 more relevant hashtags' },
    { id: 'length', name: 'Length', score: 80, maxScore: 100, weight: 0.15, suggestion: 'Optimal length' },
  ],
};
    ...
    <div className="min-h-screen bg-zinc-950 p-4 md:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button type="button" className="px-6 py-3 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-400 text-white font-semibold rounded-xl hover:from-blue-500 hover:via-blue-400 hover:to-cyan-300 transition-all flex items-center gap-2 shadow-[0_0_40px_rgba(59,130,246,0.3)]">
