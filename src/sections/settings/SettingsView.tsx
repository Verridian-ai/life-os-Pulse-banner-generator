        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] rounded-2xl p-6">
            ...
            {activeTab === 'account' && (
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button type="button" className="px-4 py-2 bg-white/5 backdrop-blur-xl border border-white/10 hover:bg-white/10 text-white rounded-xl text-sm transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
                    Change Avatar
                  </button>
                </div>
                ...
                <div>
                  ...
                  <button type="button" className="px-4 py-2 bg-red-500/10 backdrop-blur-xl border border-red-500/30 hover:bg-red-500/20 text-red-400 rounded-xl text-sm transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
                    Delete Account
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]">
                    ...
                    <button type="button" className="w-12 h-6 bg-white/10 backdrop-blur-xl border border-white/10 rounded-full relative shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { id: 'marketing', label: 'Marketing', description: 'News and product updates', enabled: false },
                    { id: 'tips', label: 'Tips & Tutorials', description: 'Get design tips and tricks', enabled: true },
                  ].map((notification) => (
                    <div
                      key={notification.id}
                      className="flex items-center justify-between p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] transition-all duration-300 hover:bg-white/10"
                    >
                      ...
                      <button type="button" className={`w-12 h-6 rounded-full relative transition-all duration-300 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] ${
                        notification.enabled
                          ? 'bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 shadow-[0_0_20px_rgba(20,184,166,0.3)]'
                          : 'bg-white/10'
                      }`}>
                        <div className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-all duration-300 shadow-[2px_2px_4px_rgba(0,0,0,0.3)] ${
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              <button type="button" className="w-full py-3 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-semibold rounded-xl hover:from-sky-400 hover:via-teal-400 hover:to-cyan-300 transition-all duration-300 shadow-[0_0_40px_rgba(20,184,166,0.3),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]">
                Save Changes
              </button>
            </div>
          </div>
