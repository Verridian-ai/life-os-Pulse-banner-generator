      ...
      <div className='w-full max-w-2xl relative z-10'>
        ...
        {step === 'start' && (
          <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.02)] rounded-2xl p-8 text-center'>
            ...
            <p className='text-zinc-400 mb-8'>Create stunning designs in seconds with AI</p>
            ...
            <div className='space-y-4'>
              ...
              <button
                type='button'
                className='w-full py-4 bg-white/5 backdrop-blur-sm border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.02)] hover:bg-white/10 text-white rounded-xl transition-all'
              >
                Use a Template
              </button>
            </div>
        ...
        {step === 'prompt' && (
          <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.02)] rounded-2xl p-8'>
            ...
            <p className='text-zinc-400 mb-6'>Be specific about what you want to create</p>
            ...
            <button
              type='button'
              className='w-full py-3 bg-white/5 backdrop-blur-sm border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.02)] hover:bg-white/10 text-teal-400 rounded-xl transition-all mb-6 flex items-center justify-center gap-2'
            >
        ...
        {step === 'format' && (
          <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.02)] rounded-2xl p-8'>
            ...
            <p className='text-zinc-400 mb-6'>Select where this design will be used</p>
        ...
        {step === 'generating' && (
          <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.02)] rounded-2xl p-8 text-center'>
            <div
              className='w-20 h-20 rounded-full border-4 border-transparent bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 animate-spin mx-auto mb-6 shadow-[0_0_40px_rgba(20,184,166,0.4)]'
              style={{
                backgroundClip: 'padding-box',
                borderImage: 'linear-gradient(135deg, #0ea5e9, #14b8a6, #22d3ee) 1',
              }}
            >
            ...
            <p className='text-zinc-400'>Creating 5 unique variants for you</p>

            <div className='mt-8 space-y-2'>
              <div className='h-2 bg-white/5 backdrop-blur-sm shadow-[inset_2px_2px_4px_rgba(0,0,0,0.4)] rounded-full overflow-hidden'>
                <div
                  className='h-full bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 rounded-full animate-pulse shadow-[0_0_15px_rgba(20,184,166,0.5)]'
                  style={{ width: '60%' }}
                />
              </div>
        ...
        {step === 'results' && (
          <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),4px_4px_16px_rgba(0,0,0,0.4),-4px_-4px_16px_rgba(255,255,255,0.02)] rounded-2xl p-8'>
            ...
            <p className='text-zinc-400 mb-6'>Select the variant you like best, or regenerate</p>
            ...
            <div className='flex gap-3'>
              ...
              <button
                type='button'
                className='flex-1 py-3 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-semibold rounded-xl hover:from-sky-400 hover:via-teal-400 hover:to-cyan-300 transition-all shadow-[0_0_20px_rgba(20,184,166,0.2),4px_4px_8px_rgba(0,0,0,0.3)]'
              >
                Open in Studio
              </button>
            </div>
