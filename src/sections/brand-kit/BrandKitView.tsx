    ...
    <div className="min-h-screen bg-zinc-950 p-4 md:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button type="button" className="px-6 py-3 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-semibold rounded-xl hover:shadow-[0_0_40px_rgba(20,184,166,0.3)] transition-all duration-300 flex items-center gap-2 shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]">
        ...
        {brands.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {brands.map((brand) => (
              ...
              >
                ...
                <div className="flex gap-2 relative">
                  ...
                  <button type="button" className="flex-1 py-2 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 hover:shadow-[0_0_20px_rgba(20,184,166,0.4)] text-white rounded-lg text-sm transition-all duration-300 shadow-[2px_2px_4px_rgba(0,0,0,0.3),-1px_-1px_2px_rgba(255,255,255,0.05)]">
                    Use Brand
                  </button>
                  <button type="button" className="w-10 h-10 bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 rounded-lg flex items-center justify-center text-zinc-400 hover:text-white transition-all duration-200 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] hover:bg-white/10">
            ...
            <button type="button" className="bg-white/5 backdrop-blur-xl border-2 border-dashed border-white/10 hover:border-teal-500/30 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[240px] transition-all duration-300 group hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
              <div className="w-12 h-12 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 group-hover:border-teal-500/30 flex items-center justify-center mb-3 transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_20px_rgba(20,184,166,0.2)]">
                <svg className="w-6 h-6 text-zinc-500 group-hover:text-teal-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
              </div>
              <p className="text-sm text-zinc-500 group-hover:text-teal-400 transition-colors duration-300">Add new brand</p>
            </button>
          </div>
        ) : (
          <div className="text-center py-16 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05),inset_0_1px_1px_rgba(255,255,255,0.1)]">
            ...
            <button type="button" className="px-6 py-3 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-medium rounded-xl hover:shadow-[0_0_40px_rgba(20,184,166,0.3)] transition-all duration-300 shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]">
              Create Brand
            </button>
          </div>
        )}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">
                Set an active brand and AI will automatically use your brand colors and fonts when generating designs. You can also extract colors from any image!
              </p>
            </div>
          </div>
        </div>
