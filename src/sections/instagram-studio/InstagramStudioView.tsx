      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='flex items-center justify-between mb-8'>
          <div>
            ...
            <p className='text-zinc-400 mt-1'>Create engaging content with hashtag optimization</p>
          </div>

          <button
            type='button'
            className='px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-[0_0_40px_rgba(236,72,153,0.3)] hover:shadow-[0_0_60px_rgba(236,72,153,0.4)]'
          >
            Schedule Post
          </button>
        </div>
            ...
            <div className='bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6'>
                  ...
                  {format === 'carousel' && (
                    <div className='absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1'>
                      {[1, 2, 3, 4, 5].map((_, i) => (
                        <div
                          key={i}
                          className={`w-1.5 h-1.5 rounded-full ${i === 0 ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-zinc-600'}`}
                        />
                      ))}
                    </div>
                  )}
              ...
              {format === 'carousel' && (
                <div className='flex items-center justify-center gap-2 mt-4'>
                  <button
                    type='button'
                    className='px-4 py-2 bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 rounded-lg text-sm text-white transition-all'
                  >
                    + Add Slide
                  </button>
              ...
              <div className='space-y-3'>
                {[
                  ...
                  >
                    ...
                    <span className='text-sm font-medium bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent group-hover:drop-shadow-[0_0_8px_rgba(74,222,128,0.4)]'>
                      {slot.score}%
                    </span>
                  </button>
                ))}
