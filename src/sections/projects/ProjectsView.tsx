...
const sampleProjects: Project[] = [
  ...
  {
    id: '2',
    name: 'AI Tools Tutorial Thumbnail',
    platform: 'youtube',
    status: 'published',
    thumbnailUrl: '',
  ...
  {
    id: '4',
    name: 'Company Anniversary Cover',
    platform: 'facebook',
    status: 'published',
    thumbnailUrl: '',
      ...
      <div className='space-y-1'>
        ...
        >
          <div className='flex items-center gap-3'>
            <svg
              className={`w-5 h-5 ${selectedFolderId === null ? 'text-teal-400' : 'text-zinc-400'}`}
              fill='none'
              viewBox='0 0 24 24'
              stroke='currentColor'
            >
            ...
            <span
              className={`text-sm ${selectedFolderId === null ? 'text-white font-medium' : 'text-zinc-300'}`}
            >
              All Designs
            </span>
          </div>
        ...
        >
          <div className='flex items-center gap-3'>
            <svg
              className={`w-5 h-5 ${selectedFolderId === 'drafts' ? 'text-teal-400' : 'text-yellow-400'}`}
              fill='none'
              viewBox='0 0 24 24'
              stroke='currentColor'
            >
            ...
            <span
              className={`text-sm ${selectedFolderId === 'drafts' ? 'text-white font-medium' : 'text-zinc-300'}`}
            >
              Drafts
            </span>
          </div>
        ...
        >
          <div className='flex items-center gap-3'>
            <svg
              className={`w-5 h-5 ${selectedFolderId === 'published' ? 'text-teal-400' : 'text-green-400'}`}
              fill='none'
              viewBox='0 0 24 24'
              stroke='currentColor'
            >
            ...
            <span
              className={`text-sm ${selectedFolderId === 'published' ? 'text-white font-medium' : 'text-zinc-300'}`}
            >
              Published
            </span>
          </div>
        ...
        {folders.map((folder) => (
          ...
          >
            <div className='flex items-center gap-3'>
              <svg
                className={`w-5 h-5 ${selectedFolderId === folder.id ? 'text-teal-400' : 'text-zinc-400'}`}
                fill='none'
                viewBox='0 0 24 24'
                stroke='currentColor'
              >
              ...
              <span
                className={`text-sm ${selectedFolderId === folder.id ? 'text-white font-medium' : 'text-zinc-300'}`}
              >
                {folder.name}
              </span>
            </div>
  ...
  return (
    <div className='min-h-screen bg-zinc-950 p-4 md:p-6 lg:p-8 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden pointer-events-none'>
        ...
        <div className='absolute inset-0 opacity-[0.02] bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[length:50px_50px]' />
      </div>
        ...
        <div className='mb-8'>
          <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <div>
              ...
              <p className='text-zinc-400 mt-1'>{projectCounts.all} designs in your library</p>
            </div>
          ...
          <div className='flex flex-col lg:flex-row gap-4'>
            ...
            <div className='flex gap-3'>
              ...
              <select
                ...
                className='px-4 py-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl text-white focus:outline-none focus:border-teal-500/50 transition-all appearance-none cursor-pointer'
              >
                <option value='updatedAt' className='bg-zinc-900'>
                  Date Updated
                </option>
                <option value='createdAt' className='bg-zinc-900'>
                  Date Created
                </option>
                <option value='name' className='bg-zinc-900'>
                  Name
                </option>
                <option value='platform' className='bg-zinc-900'>
                  Platform
                </option>
              </select>
