        ...
        <div className={`${glassStyles.card} rounded-3xl p-6 md:p-8 mb-8`}>
          <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <div>
              ...
              <p className='text-zinc-400 mt-1'>What would you like to create today?</p>
            </div>
            ...
            <div className={`${glassStyles.card} rounded-2xl p-4`}>
              ...
              <div className='space-y-2'>
                ...
                >
                  ...
                  <svg
                    className='w-4 h-4 text-zinc-500 ml-auto group-hover:translate-x-1 transition-transform'
                    fill='none'
                    viewBox='0 0 24 24'
                    stroke='currentColor'
                  >
