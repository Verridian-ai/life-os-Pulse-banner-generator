...
const glassStyles = {
  ...
  cardHover:
    'hover:bg-white/10 hover:border-white/20 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3),inset_0_1px_1px_rgba(255,255,255,0.15)]',
  neumorphicInset:
...
function Platform3DIcon({
  ...
  const branding =
    platformBranding[platformId as keyof typeof platformBranding] || platformBranding.linkedin;
...
export function PlatformCard({
  ...
  const branding =
    platformBranding[platform.id as keyof typeof platformBranding] || platformBranding.linkedin;
...
export function RecentDesignCard({
  ...
  const branding =
    platformBranding[design.platform as keyof typeof platformBranding] || platformBranding.linkedin;
