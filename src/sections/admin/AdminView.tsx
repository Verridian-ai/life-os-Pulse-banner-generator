...
const sampleUsers = [
  { id: '1', email: 'john@example.com', name: 'John Doe', plan: 'Pro', generations: 234, lastActive: '2 hours ago' },
  { id: '2', email: 'sarah@example.com', name: 'Sarah Smith', plan: 'Free', generations: 45, lastActive: '1 day ago' },
  { id: '3', email: 'mike@example.com', name: 'Mike Johnson', plan: 'Pro', generations: 567, lastActive: '5 min ago' },
];

// Glass card style helper
const glassCard = "bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl";

// Neumorphic raised effect helper
const neumorphicRaised = "shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)]";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-zinc-400 mt-1">
            Monitor and manage your Signal instance
          </p>
        </div>
                ...
                >
                  ...
                  <div className="flex items-end justify-between">
                    ...
                    <span className={`text-sm font-medium px-2 py-0.5 rounded-full ${
                      stat.changeType === 'up' ? 'text-green-400 bg-green-500/10' :
                      stat.changeType === 'down' && stat.label === 'Error Rate' ? 'text-green-400 bg-green-500/10' :
                      stat.changeType === 'down' ? 'text-amber-400 bg-amber-500/10' : 'text-zinc-400'
                    }`}>
                      {stat.change}
                    </span>
                  </div>
          ...
          <div className="space-y-6">
            <div className={`${glassCard} p-6`}>
              ...
              <div className="space-y-2 font-mono text-sm">
                {[
                  { level: 'info', message: '[2024-01-15 10:23:45] User john@example.com generated image', time: '2 min ago' },
                  { level: 'warn', message: '[2024-01-15 10:22:12] High latency detected on image generation', time: '3 min ago' },
                  { level: 'info', message: '[2024-01-15 10:21:00] New user signup: mike@example.com', time: '4 min ago' },
                  { level: 'error', message: '[2024-01-15 10:20:30] Replicate API rate limit exceeded', time: '5 min ago' },
                ].map((log, i) => (
                  <div
                    key={i}
        ...
        {activeTab === 'finance' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Revenue Card */}
              <div className={`${glassCard} ${neumorphicRaised} p-6 shadow-[0_0_40px_rgba(34,197,94,0.15)]`}>
                <p className="text-sm text-zinc-400 mb-1">Monthly Revenue</p>
                <p className="text-2xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">$12,847</p>
              ...
              {/* API Costs Card */}
              <div className={`${glassCard} ${neumorphicRaised} p-6 shadow-[0_0_40px_rgba(251,191,36,0.15)]`}>
                <p className="text-sm text-zinc-400 mb-1">API Costs</p>
                <p className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">$2,341</p>
              ...
              {/* Net Margin Card */}
              <div className={`${glassCard} ${neumorphicRaised} p-6 shadow-[0_0_40px_rgba(20,184,166,0.2)]`}>
                <p className="text-sm text-zinc-400 mb-1">Net Margin</p>
                <p className="text-2xl font-bold bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 bg-clip-text text-transparent">$10,506</p>
            ...
            <div className={`${glassCard} p-6`}>
              ...
              <div className="space-y-4">
                {[
                  { model: 'GPT-4 Vision', cost: '$890', percentage: 38, color: 'from-sky-500 to-cyan-400' },
                  { model: 'DALL-E 3', cost: '$654', percentage: 28, color: 'from-teal-500 to-emerald-400' },
                  { model: 'Replicate (SDXL)', cost: '$432', percentage: 18, color: 'from-violet-500 to-purple-400' },
                  { model: 'Whisper', cost: '$234', percentage: 10, color: 'from-amber-500 to-orange-400' },
                  { model: 'Other', cost: '$131', percentage: 6, color: 'from-zinc-500 to-zinc-400' },
                ].map((item) => (
                  <div key={item.model}>
