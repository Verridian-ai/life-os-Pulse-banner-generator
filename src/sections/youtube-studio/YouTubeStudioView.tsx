...
const sampleCTRScore = {
  score: 6.8,
  factors: [
    { id: 'text', name: 'Text Readability', score: 85, maxScore: 100, suggestion: 'Good contrast and size' },
    { id: 'face', name: 'Face Presence', score: 90, maxScore: 100, suggestion: 'Clear face with expression' },
    { id: 'contrast', name: 'Color Contrast', score: 70, maxScore: 100, suggestion: 'Could be more vibrant' },
    { id: 'relevance', name: 'Title Relevance', score: 65, maxScore: 100, suggestion: 'Improve title-thumbnail match' },
    { id: 'brand', name: 'Brand Consistency', score: 80, maxScore: 100, suggestion: 'Matches channel style' },
  ],
};
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-zinc-400 mt-1">
              Optimize thumbnails and titles for higher CTR
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button type="button" className="px-6 py-3 bg-gradient-to-r from-red-600 via-red-500 to-rose-400 text-white font-semibold rounded-xl hover:from-red-500 hover:to-rose-300 transition-all shadow-[0_0_40px_rgba(239,68,68,0.3)] hover:shadow-[0_0_50px_rgba(239,68,68,0.4)]">
              Export Thumbnail
            </button>
          </div>
        </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6">
              ...
              <div className="aspect-video bg-zinc-800/50 backdrop-blur-sm rounded-xl overflow-hidden relative group border border-white/5">
                ...
                <div className="absolute inset-0 bg-black/50 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <button type="button" className="px-6 py-3 bg-gradient-to-r from-red-600 via-red-500 to-rose-400 text-white font-medium rounded-lg shadow-[0_0_30px_rgba(239,68,68,0.4)]">
                    Generate Thumbnail
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.keyword} className="flex items-center justify-between p-3 bg-white/5 backdrop-blur-sm border border-white/5 rounded-xl">
