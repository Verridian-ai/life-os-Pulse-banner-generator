  ...
  return (
    <div className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-2xl p-6">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className={`p-3 rounded-xl border backdrop-blur-sm ${hasNumber ? 'bg-green-500/10 border-green-500/30 shadow-[0_0_15px_rgba(34,197,94,0.1)]' : 'bg-white/5 border-white/10'}`}>
        ...
        <div className={`p-3 rounded-xl border backdrop-blur-sm ${hasEmotionalTrigger ? 'bg-green-500/10 border-green-500/30 shadow-[0_0_15px_rgba(34,197,94,0.1)]' : 'bg-white/5 border-white/10'}`}>
          <div className="flex items-center gap-2">
            {hasEmotionalTrigger ? (
              <svg className="w-5 h-5 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
