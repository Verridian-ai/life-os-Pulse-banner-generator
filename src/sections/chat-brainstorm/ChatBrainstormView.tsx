...
const sampleMessages: Message[] = [
  {
    id: '1',
    role: 'user',
    content: 'I need to create a LinkedIn banner for my tech startup. We focus on AI-powered design tools.',
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <header className="h-14 bg-white/5 backdrop-blur-xl border-b border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] flex items-center px-4 gap-4">
          ...
          <div className="hidden sm:flex items-center gap-1 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-1">
            <button type="button" className="px-3 py-1.5 rounded-lg text-sm font-medium bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white shadow-[0_0_20px_rgba(20,184,166,0.3)]">
              Design
            </button>
            <button type="button" className="px-3 py-1.5 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-white/5 transition-colors">
              Search
            </button>
            <button type="button" className="px-3 py-1.5 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-white/5 transition-colors">
              Voice
