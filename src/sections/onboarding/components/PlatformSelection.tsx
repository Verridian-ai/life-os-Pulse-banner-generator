          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4 w-full mb-8'>
            {platforms.map((platform) => (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`w-14 h-14 ${platform.color} rounded-xl flex items-center justify-center text-white mx-auto mb-3 shadow-[4px_4px_8px_rgba(0,0,0,0.3),-2px_-2px_6px_rgba(255,255,255,0.05)]`}
                >
                  {platform.icon}
                </div>
