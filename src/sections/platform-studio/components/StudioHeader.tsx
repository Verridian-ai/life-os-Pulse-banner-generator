  ...
  return (
    <header className="h-14 bg-white/5 backdrop-blur-xl border-b border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] flex items-center px-4 gap-4 relative z-20">
      ...
      <div className="flex items-center gap-2">
        {/* Voice Agent */}
        <button type="button" className="w-10 h-10 rounded-xl bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 flex items-center justify-center text-white shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:shadow-[0_0_30px_rgba(20,184,166,0.5)] transition-shadow">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Export */}
        <button type="button" className="hidden md:flex px-4 py-2 bg-white/5 backdrop-blur border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] hover:bg-white/10 rounded-lg text-sm font-medium text-white transition-all gap-2 items-center">
