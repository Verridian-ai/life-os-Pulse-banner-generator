      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button type="button" className="p-3 bg-white/5 backdrop-blur border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] hover:bg-white/10 rounded-xl text-sm text-zinc-300 transition-all flex items-center gap-2">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            <button type="button" className="w-full p-3 bg-white/5 backdrop-blur border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] hover:bg-white/10 rounded-xl text-sm text-zinc-300 transition-all flex items-center gap-3">
