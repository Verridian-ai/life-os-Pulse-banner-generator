  ...
  return (
    <div className="h-screen flex flex-col bg-zinc-950 relative overflow-hidden">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 p-4 bg-white/5 backdrop-blur-xl border-t border-white/10 z-20">
        <button type="button" className="w-full py-4 bg-gradient-to-r from-sky-500 via-teal-500 to-cyan-400 text-white font-semibold rounded-xl flex items-center justify-center gap-2 shadow-[0_0_40px_rgba(20,184,166,0.3)] hover:shadow-[0_0_60px_rgba(20,184,166,0.4)] transition-shadow">
