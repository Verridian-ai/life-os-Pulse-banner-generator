...
3. Verify you are authenticated and session is valid
...
- Results are stored in Google Cloud Storage automatically
...
2. **Store in Neon database** for production
   - Encrypted per-user storage
   - Session-based access control via Lucia Auth
...
- [Voice Agent Guide](./VOICE_AGENT_GUIDE.md) - Voice-activated features
- [Voice Commands Reference](./VOICE_COMMANDS_REFERENCE.md) - Quick command reference
