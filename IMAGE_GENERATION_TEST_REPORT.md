...
(function() {
    ...
    console.log('Image Model:', localStorage.getItem('llm_image_model') || 'gemini-3-pro-image-preview (default)');
    ...
    const generateBtn = document.querySelector('button:has(.material-icons:contains("draw"))') ||
                       Array.from(document.querySelectorAll('button')).find(b =>
                           b.textContent.includes('Generate Background') ||
    ...
    // Check textarea
    const textarea = document.querySelector('textarea[placeholder*="vision"]') ||
